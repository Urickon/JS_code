...
Unknown - тип, введенный в Type Script 3.0. Работает похожим образом с any, мы можем присвоить ему любой тип
данных, но для действий с ними нужна проверка. То есть any по сути позволяет очень многое, а unknown как бы 
говорит, что мы ничего не знаем об этом типе и нужна проверка.
