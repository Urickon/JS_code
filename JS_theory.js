...
КОНЦЕПЦИЯ ООП (Объектно-ориентированное)
...
Можно работать со строкой, перебирая все ее элементы.
...
xhr.status //тескт сообщения от сервера (не найдено)
...
//При работе с JSON и преобразования в/из строки сипользуются методы
JSON.parse()
JSON.stringify()
