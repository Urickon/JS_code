...
ENTRYPOINT - всегда выполняется при запуске контейнера, используется когда контейнер - исполняемый файл.
...
===========================================================================================================
Docker network
В docker-compose создается автоматически.
Контейнеры присоединяются к созданной сети под именами, которые указаны в services.

Нужна для взаимодействия между контейнерами.
